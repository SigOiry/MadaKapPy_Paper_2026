...
#| warning: false
#| message: false
#| fig-cap: "Harvested biomass of cultivation plot in 2025. (A) Frequency distribution of harvested biomass. (B) Temporal variability of the Daily Growth Rate (DGR) of harvested plots in 2025. Colors distinguish Est and West plot positions, solid curves show generalized additive model (GAM) trends fitted with cubic regression splines, and shaded envelopes indicate 95% confidence intervals."
#| out-width: "100%"
